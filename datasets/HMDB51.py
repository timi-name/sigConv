...
class HMDBData(Datasets):
    def __init__(self, args, ground_truth, modality, phase='train'):
        super(HMDBData, self).__init__(args, ground_truth, modality, phase)
    ...
    def __getitem__(self, index):
        ...
        sl = self.equal_part_sample(self.inputs[index][1], self.sample_duration)
